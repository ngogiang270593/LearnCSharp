...
namespace Identity.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(100, ErrorMessage = "{0} phải nhập từ {2} đến {1}.", MinimumLength = 6)]
            ...
            [Compare("Password", ErrorMessage = "{0} không trùng với mật khẩu.")]
                ...
                if (result.Succeeded)
                {
                   ...
                   var callbackUrl = Url.Page(
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Xác thực địa chỉ email",
                        $"Hãy xác thực địa chỉ email bằng cách <a href='{callbackUrl}'>Bấm vào đây</a>.");
